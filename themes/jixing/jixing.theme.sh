...
SCM_THEME_PROMPT_PREFIX="${_omb_prompt_navy}|"
SCM_THEME_PROMPT_SUFFIX="${_omb_prompt_navy}| "
SCM_THEME_PROMPT_FORMAT="${SCM_THEME_PROMPT_PREFIX}%s${SCM_THEME_PROMPT_SUFFIX} "
...
function _omb_theme_PROMPT_COMMAND() {
    ...
    local hostname="${_omb_prompt_purple}\u@\h"
    ...
    PS1="$python_venv${hostname} ${_omb_prompt_green}\w $(scm_prompt_char_info)${ret_status}${_omb_prompt_normal}"
}
